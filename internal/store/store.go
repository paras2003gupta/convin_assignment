...
// InsertEvent stores the raw delivery. It returns true if the row was inserted,
// or false if the event_id already existed (idempotent duplicate). The UNIQUE
// constraint on event_id makes this safe even under concurrent redeliveries.
